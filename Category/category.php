...
<body>
    ...
    <div class="choices">
        <div class="card-body">
            ...
            ?>
                            <div id=container2>
                                <input type="checkbox" name="categories[]" value="<?= $categorylist['category']; ?>"
                                    <?php if(in_array($categorylist['category'], $checked)){ echo "checked"; }?>
                                />
        ...
        <div class="card shadow at-3">
            <div class="card-header">
                    <button type="submit" class="btns2">FILTER ME</button>
            </div>
        </div>
    </div>
    </form>
    ...
    <section class="items">
        ...
        if(isset($_GET['categories']))
        {
            ...
            {
                //echo $rowcategory;
                $query = "SELECT * FROM user WHERE category = '$rowcategory'";
